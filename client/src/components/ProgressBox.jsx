...
const Box = ({ title, icon, result, progress, today }) => {
  return (
    <div className="flex items-start px-8 py-5 space-x-4 transition-transform duration-500 bg-white border rounded-md hover:transform hover:-translate-y-4 border-slate-100">
      ...
      <div className="w-full">
        <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <Box
            ...
            result={(total_difficulty / total_solve).toFixed(2)}
            progress="5.0"
            today="+45 today"
          />
        </div>
