...
import { Box, Button, Paper, Stack, TextInput, Title, MultiSelect, useMantineTheme } from "@mantine/core"
      ...
      {problem && (
        <form onSubmit={handleSubmit}>
          <Stack>
            ...
            <TextInput type="number" label="Online Judge ID" disabled {...form.getInputProps("onlineJudgeId")} />
