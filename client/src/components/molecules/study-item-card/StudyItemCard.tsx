import { Box, Button, Group, Menu, Paper, Text, Title, useMantineTheme } from "@mantine/core"
import {
  IconDotsVertical,
  IconEdit,
  IconExternalLink,
...
import { StudyFormModal, StudyDeleteModal } from "~/components/molecules"
...
export default function StudyItemCard(props: Study) {
  ...
  return (
    <Paper p="lg" sx={{ borderRadius: theme.radius.md, position: "relative" }}>
      ...
      {/* edit study modal */}
      <StudyFormModal open={editOpen} setOpen={setEditOpen} study={props} forUpdate />

      {/* study delete confirmation modal */}
      <StudyDeleteModal setOpen={setDeleteOpen} open={deleteOpen} item={props} />
    </Paper>
  )
}
