...
import GroupRemoveMemberModal from "../group-remove-member-modal/GroupRemoveMemberModal"
...
export default function GroupMemberCard({ userGroup, group, isOwner }: GroupMemberCardProps) {
  ...
  return (
    <>
      ...
      {group && user && (
        <GroupRemoveMemberModal isOpen={opened} setIsOpen={setOpened} data={{ group, user }} />
      )}
    </>
  )
}
