  ...
  return {
    ...
    topShadow: {
      ...
      background: `linear-gradient(${theme.fn.rgba(
        theme.black,
        shadowGradientAlpha
      )}, ${theme.fn.rgba(theme.black, 0)}), linear-gradient(${theme.fn.rgba(
        theme.black,
        shadowGradientAlpha
    ...
    leftShadow: {
      ...
      background: `linear-gradient(to right, ${theme.fn.rgba(
        ...
        theme.black,
        0
      )}), linear-gradient(to right, ${theme.fn.rgba(
        theme.black,
        shadowGradientAlpha
      )}, ${theme.fn.rgba(theme.black, 0)} 30%)`
    },
    rightShadow: {
      ...
      right: 0,
      width: theme.spacing.sm,
      background: `linear-gradient(to left, ${theme.fn.rgba(
        theme.black,
        shadowGradientAlpha
      )}, ${theme.fn.rgba(
        theme.black,
        0
      )}), linear-gradient(to left, ${theme.fn.rgba(
        theme.black,
        shadowGradientAlpha
      )}, ${theme.fn.rgba(theme.black, 0)} 30%)`
    },
    bottomShadow: {
      ...
      background: `linear-gradient(${theme.fn.rgba(
        ...
        theme.black,
        0
      )} 30%, ${theme.fn.rgba(theme.black, shadowGradientAlpha)})`
    },
    shadowVisible: {
      opacity: 1
    }
    ...
    >
      ...
      <Box
        className={cx(classes.shadow, classes.topShadow, {
          [classes.shadowVisible]: topShadowVisible
        })}
        sx={{ top: headerHeight }}
      />
      <div
        className={cx(classes.shadow, classes.leftShadow, {
          [classes.shadowVisible]: leftShadowVisible
        })}
      />
      <div
        className={cx(classes.shadow, classes.rightShadow, {
          [classes.shadowVisible]: rightShadowVisible
        })}
      />
      <Box
        className={cx(classes.shadow, classes.bottomShadow, {
          [classes.shadowVisible]: bottomShadowVisible
        })}
        sx={{ bottom }}
      />
    </ScrollArea>
