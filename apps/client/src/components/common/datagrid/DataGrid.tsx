...
import { globalFilterFn } from "./GlobalFilter";
import {
...
export function DataGrid<TData extends RowData>({
  ...
  const [tableWidth, setTableWidth] = useState<number | string>(
    width ?? "100%"
  );
  ...
  const table = useReactTable<TData>({
    ...
    getFilteredRowModel:
      options?.enableFilters || withGlobalFilter || withColumnFilters
        ? getFilteredRowModel()
        : undefined,
    getPaginationRowModel:
      options?.enableFilters || withPagination
        ? getPaginationRowModel()
        : undefined,
    getSortedRowModel:
      options?.enableSorting || withSorting ? getSortedRowModel() : undefined,
    getExpandedRowModel:
      options?.enableExpanding || withRowExpanding
        ? getExpandedRowModel()
        : undefined,
    getRowCanExpand,
  ...
  return (
    <Stack {...others} spacing={0} className={classes.wrapper}>
      {/* {withGlobalFilter && (
        <Group sx={{ margin: "0 16px" }}>
          <GlobalFilter
            table={table}
      ...
      >
        ...
        >
          ...
          <BodyWrapper table={table} className={classes.tbody} role="rowgroup">
            ...
            {paddingBottom > 0 &&
              virtualizerPlaceholder(paddingBottom, colSpan)}
          </BodyWrapper>
        </MantineTable>
      </ScrollArea>
...
const virtualizerPlaceholder = (
  ...
  isEven ? (
    <>
      <tr>
        <td
          style={{ height: `${padding / 2}px`, padding: 0 }}
          colSpan={colSpan}
        />
      </tr>
      <tr>
