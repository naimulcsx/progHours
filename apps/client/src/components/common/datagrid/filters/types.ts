...
export type DataGridFilterElement<TFilter = unknown> = ComponentType<
  DataGridFilterElementProps<TFilter>
>;
...
export type DataGridFilterInput<TFilterValue> = ComponentType<
  DataGridFilterInputProps<TFilterValue>
>;
