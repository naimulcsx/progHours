...
export const DefaultHeaderWrapper: ComponentType<
  DataGridHeaderWrapperProps<any>
> = ({ table, ...rest }) => <thead {...rest} />;
export const DefaultHeaderRow: ComponentType<DataGridHeaderRowProps<any>> = ({
  table,
  headerGroup,
  ...rest
}) => <tr {...rest} />;
export const DefaultHeaderCell: ComponentType<DataGridHeaderCellProps<any>> = ({
  table,
  header,
  ...rest
}) => <th {...rest} />;
export const DefaultBodyWrapper: ComponentType<
  DataGridBodyWrapperProps<any>
> = ({ table, ...rest }) => <tbody {...rest} />;
export const DefaultBodyRow: ComponentType<DataGridBodyRowProps<any>> = ({
  table,
  row,
  ...rest
}) => <tr {...rest} />;
export const DefaultBodyCell: ComponentType<DataGridBodyCellProps<any>> = ({
  table,
  cell,
  ...rest
}) => <td {...rest} />;
